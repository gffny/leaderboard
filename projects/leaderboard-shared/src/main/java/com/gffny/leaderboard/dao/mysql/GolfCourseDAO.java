...
public class GolfCourseDAO extends AbstractMySQLDAO {
	...
	public List<IGolfCourse> getCourseById(String courseId) throws DAOException {
		...
		try {
			stmnt = getConnection()
					.prepareStatement(
							"select * from t_club_course c INNER JOIN t_golf_club g ON c.golf_club_id=g.golf_club_id WHERE course_id=?");
			stmnt.setString(1, courseId);
			ResultSet res = stmnt.executeQuery();
			while (res.next()) {
				/*
				 * String[] holeParArray = { res.getString("par_hole_1"),
				 * res.getString("par_hole_2"), res.getString("par_hole_3"),
				 * res.getString("par_hole_4"), res.getString("par_hole_5"),
				 * res.getString("par_hole_6"), res.getString("par_hole_7"),
				 * res.getString("par_hole_8"), res.getString("par_hole_9"),
				 * res.getString("par_hole_10"), res.getString("par_hole_11"),
				 * res.getString("par_hole_12"), res.getString("par_hole_13"),
				 * res.getString("par_hole_14"), res.getString("par_hole_15"),
				 * res.getString("par_hole_16"), res.getString("par_hole_17"),
				 * res.getString("par_hole_18") }; String[] holeIndex = {
				 * res.getString("index_hole_1"), res.getString("index_hole_2"),
				 * res.getString("index_hole_3"), res.getString("index_hole_4"),
				 * res.getString("index_hole_5"), res.getString("index_hole_6"),
				 * res.getString("index_hole_7"), res.getString("index_hole_8"),
				 ...
				 * res.getString("index_hole_18") }; String[] teeDistance = {
				 ...
				 * holeParArray,// String[] holePar; holeIndex,// String[]
				 * holeIndex; teeDistance // String[] goldTeeDistance; ));
				 */
			}
