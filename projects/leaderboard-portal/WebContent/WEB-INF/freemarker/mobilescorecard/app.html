...
<html>
	...
	<body>
		...
		<!-- hole details -->
		<div data-role=page id=holeDetail hidden=true>
			<div class="ui-header ui-bar-a" data-role=header role=banner>
			...
			<span id=mblscrdHoleDetailPrevHole><a id=mblscrdHoleDetailPrevHoleBtn data-role=button data-corners=true data-shadow=true data-iconshadow=true data-wrapperels=span data-theme=c href=#holeDetail>Previous Hole</a></span>
			<span id=mblscrdHoleDetailNextHole><a id=mblscrdHoleDetailNextHoleBtn data-role=button data-corners=true data-shadow=true data-iconshadow=true data-wrapperels=span data-theme=c href=#holeDetail>Next Hole</a></span>
			<span id=mblscrdHoleDetailCompleteScorecard><a id=mblscrdHoleDetailCompleteScorecardBtn data-role=button data-corners=true data-shadow=true data-iconshadow=true data-wrapperels=span data-theme=c href=#scorecardDetail>Complete Scorecard</a></span>
		</div>
		<!-- scorecard details -->
		<div data-role=page id=scorecardDetail hidden=true>
			<div class="ui-header ui-bar-a" data-role=header role=banner>
